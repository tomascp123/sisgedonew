...
<table width="100%"  height="80%"  border="0" cellpadding="0" cellspacing="10"  class="backform" >
	<tr>
		<td valign="top" > 
			<table class="frmline" width="755" align="center"  border="0" cellpadding="0" cellspacing="0">
				...
				<?	
                                    ...
                                    $MyExpdte = new clsExpediente($_POST[txtexpeid]);
                                    $MyExpdte->consulta_expdte();

                                    if($MyExpdte->_rsExpdte) { // Si tiene trámite
                                        seccion("REGISTROS DEL EXPEDIENTE",3,3);
				...
				<tr>
					<td colspan="7" bgcolor="#CDD5DB" height="30" align="right">
					 <input  type="button" class="boton" name="btn_imprime" onClick="AbreVentana('../reports/expedientereporte.php?_expe_id=<? echo $_POST[txtexpeid] ?>','Tramite')" value=".:: Imprimir ::." >&nbsp;&nbsp;
