	...
	<table width="636" bgcolor="#006699">
		...
		<tr bgcolor="#DDDD88">
		  <td colspan="2" bgcolor="#EFEFEF"><ol class="style11">
		    <li>
		      <div align="justify"><span class="style9"> Su pedido ha sido enviado satisfactoriamente al funcionario responsable del acceso a la infromaci&oacute;n p&uacute;blica del <? echo _EMPRESA_ ?> el d&iacute;a <? echo fecha_completa(); ?>.</span></div>
		    </li>
	        <li class="style9">
	          <div align="justify">El n&uacute;mero de expediente de su pedido de informaci&oacute;n es el <span class="Estilo2"><? echo $idinsert ?></span>.  Haga el seguimiento del tr&aacute;mite a trav&eacute;s del Sistema de Gesti&oacute;n Documentaria <a href="javascript:AbreVentana('main.php')">SisGeDo</a>.</div>
	        </li>
		    <li class="style9">
		    ...
		    <li class="style9">
		      <div align="justify">Si desea revisar documentos, comun&iacute;quese al d&iacute;a h&aacute;bil siguiente del envio de esta comunicaci&oacute;n, con el funcionario responsable del acceso a la informaci&oacute;n al tel&eacute;fono 074-210728, para que le indique en que oficina puede acceder al documento.</div>
		    </li>
		    </ol>
		    <p align="center" class="Estilo1">Este documento es el cargo del pedido de informaci&oacute;n </p>
	      <p>&nbsp;	    </p></td>
	  </tr>
		<tr bgcolor="#006699">
