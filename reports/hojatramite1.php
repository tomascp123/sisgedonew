...
<table width="650" border="0">
  ...
  <tr>
    <td colspan="6"><div align="center"><strong>HOJA DE TRAMITE</strong>
    </div></td>
  </tr>
  <tr>
    <td height="22" width="90"><div align="right"><strong>Remitente</strong></div></td>
    <td width="260"><? echo $row[origen];  ?></td>
    <td height="22" width="100"><div align="right"><strong>N&deg; Expediente</strong></div></td>
    <td width="180"><? echo $row[expe_id]; ?></td>
  </tr>
  <tr>
...
<table width="650" height="160" border="1" cellpadding="0" cellspacing="0">
  <tr>
